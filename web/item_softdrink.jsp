<%-- 
    Document   : item_softdrink
    Created on : Apr 8, 2017, 12:24:17 PM
    Author     : Rahul
--%>
...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="top-header">
				<div class="logo">
					<a href="#"><img src="images/fuel-pizza.jsp" class="img-responsive" alt="" /></a>
				</div>
				<div class="queries">
	...
	<div class="container">
		<div class="order-top">
			<li class="item-lists"><h4>Soft Drinks</h4>
				<p>Coca-cola</p>
				<P> Pepsi-cola</P>
				<P> Mountain dew</P>
				<P> Sprite</P>
			...
			<li class="item-lists">
				<div class="special-info grid_1 simpleCart_shelfItem">
					...
					<div class="pre-top">
						<div class="pr-left">
							<div class="item_add"><span class="item_price"><h6>ONLY  35.00</h6></span></div>
						</div>
						<div class="pr-right">
							<div class="item_add"><span class="item_price"><a href="#">Pick</a></span></div>
						</div>
					...
					<div class="pre-top">
						...
						<div class="pr-right">
							...
							<div class="clearfix"></div>
                                        ...
                                        <div class="pre-top">
						<div class="pr-left">
							<div class="item_add"><span class="item_price"><h6>ONLY  25.00</h6></span></div>
						</div>
						<div class="pr-right">
							<div class="item_add"><span class="item_price"><a href="#">Pick</a></span></div>
						</div>
